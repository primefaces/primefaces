...
public class WidgetBuilderTest {
    ...
    public void shouldBuildBasicWidget() throws IOException {
        ...
        assertEquals(
        		"<script id=\"accoId_s\" type=\"text/javascript\">PrimeFaces.cw(\"AccordionPanel\",{id:\"accoId\",widgetVar:\"acco\"});</script>",
        		writer.toString());
    }
    ...
    public void initWithWindowLoad() throws IOException {
        ...
        assertEquals(
        		"<script id=\"accoId_s\" type=\"text/javascript\">$(window).load(function(){PrimeFaces.cw(\"AccordionPanel\",{id:\"accoId\",widgetVar:\"acco\"});});</script>",
        		writer.toString());
    }
    ...
    public void initWithComponentLoad() throws IOException {
        ...
        assertEquals(
        		"<script id=\"accoId_s\" type=\"text/javascript\">$(PrimeFaces.escapeClientId(\"test\")).load(function(){PrimeFaces.cw(\"AccordionPanel\",{id:\"accoId\",widgetVar:\"acco\"});});</script>",
        		writer.toString());
    }
    ...
    public void shouldBuildWithAttributes() throws IOException {
        ...
        assertEquals(
        		"<script id=\"dt1_s\" type=\"text/javascript\">$(function(){PrimeFaces.cw(\"DataTable\",{id:\"dt1\",widgetVar:\"dt\",selectionMode:\"single\",lazy:true});});</script>",
        		writer.toString());
    }
    ...
    public void shouldBuildWithCallbacks() throws IOException {
        ...
        assertEquals("<script id=\"dt1_s\" type=\"text/javascript\">PrimeFaces.cw(\"DataTable\",{id:\"dt1\",widgetVar:\"dt\",selectionMode:\"single\",lazy:true,onRowSelect:function(row){alert(row);}});</script>", writer.toString());
    }
    ...
    public void shouldBuildWithResourcePath() throws IOException {
        ...
        assertEquals("<script id=\"accoId_s\" type=\"text/javascript\">PrimeFaces.cw(\"AccordionPanel\",{id:\"accoId\",widgetVar:\"acco\"},\"accordion\");</script>", writer.toString());
    }
}
