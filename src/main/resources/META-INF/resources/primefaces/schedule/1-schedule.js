...
PrimeFaces.widget.Schedule = PrimeFaces.widget.DeferredWidget.extend({
    ...
    init: function(cfg) {
        ...
        this.cfg.slotLabelFormat = this.cfg.slotLabelFormat || undefined;
        ...
        this.cfg.locale = this.cfg.locale.toLowerCase().replace("_", "-"); //adjust locale to FullCalendar-locale
    ...
    configureLocale: function() {
        ...
        if (lang) {
            if (lang.firstDay !== undefined) { this.cfg.firstDay = lang.firstDay; }
            if (lang.weekNumberTitle) { this.cfg.weekLabel = lang.weekNumberTitle; }
            if (lang.allDayText) { this.cfg.allDayText = lang.allDayText; }
            if (lang.eventLimitText || lang.moreLinkText) { this.cfg.eventLimitText = lang.moreLinkText || lang.eventLimitText; }
            ...
            this.cfg.buttonText = buttonText;
        }
    },
