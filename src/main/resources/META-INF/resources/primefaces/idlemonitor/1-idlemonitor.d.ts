...
declare namespace JQueryIdleTimer {
    ...
    export interface IdleTimerMethods {
         ...
         * @return this JQuery instance for chaining.
         */
        idleTimer(idleTimeoutMillis: number): this;
         ...
         * @return this JQuery instance for chaining.
         */
        idleTimer(options: Partial<JQueryIdleTimer.IdleTimerOptions>): this;
         ...
         */
        idleTimer(method: "getRemainingTime"): number;
         ...
         */
        idleTimer(method: "getElapsedTime"): number;
         ...
         * to active. 
         */
        idleTimer(method: "getLastActiveTime"): number;
         ...
         */
        idleTimer(method: "isIdle"): boolean;
    }
