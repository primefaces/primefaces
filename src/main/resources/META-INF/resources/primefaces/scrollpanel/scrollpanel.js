		...
		function JScrollPane(elem, s)
		{
			...
			function initialise(s)
			{
				...
				if (pane === undefined) {
					...
					*/
					...
					container.find('>.ui-scrollpanel-vbar,>.ui-scrollpanel-hbar').remove().end();
				}
			...
			function initialiseVerticalScroll()
			{
				if (isScrollableV) {
					...
					verticalBar = container.find('>.ui-scrollpanel-vbar');
					verticalTrack = verticalBar.find('>.ui-scrollpanel-track');
					...
					container.find('>.ui-scrollpanel-vbar>.ui-scrollpanel-cap:visible,>.ui-scrollpanel-vbar>.jspArrow').each(
						function()
						{
			...
			function initialiseHorizontalScroll()
			{
				if (isScrollableH) {
					...
					horizontalBar = container.find('>.ui-scrollpanel-hbar');
					horizontalTrack = horizontalBar.find('>.ui-scrollpanel-track');
			...
			{
				container.find('>.ui-scrollpanel-hbar>.ui-scrollpanel-cap:visible,>.ui-scrollpanel-hbar>.jspArrow').each(
					function()
					{
			...
			function resizeScrollbars()
			{
				if (isScrollableH && isScrollableV) {
					...
					$(horizontalBar).find('>.ui-scrollpanel-cap:visible,>.jspArrow').each(
						function()
						{
							horizontalTrackWidth += $(this).outerWidth();
						}
			...
			function scrollToElement(ele, stickToTop, animate)
			{
				...
				while (!e.is('.ui-scrollpanel-content')) {
