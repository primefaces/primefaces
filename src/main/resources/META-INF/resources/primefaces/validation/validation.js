...
if (window.PrimeFaces) {
    ...
    PrimeFaces.converter = {
        ...
        'javax.faces.Integer': {
            ...
            convert: function(element, submittedValue) {
                ...
                if(String.prototype.trim.call(submittedValue).length === 0) {
                    return null;
                }
    ...
    PrimeFaces.validateInput = function(element) {
        ...
        if(valid && ((submittedValue !== null && String.prototype.trim.call(submittedValue).length > 0)||PrimeFaces.settings.validateEmptyFields)) {
