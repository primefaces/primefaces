 ...
 * <p/>
 * {@link org.primefaces.push.annotation.PushEndpoint} are registered against a path, defined using the
 * {@link org.primefaces.push.annotation.PushEndpoint#value}.
 * There can be multiple PushEndpoint registered against each path, and a particular PushEndpoint can be registered against multiple paths.
 * The event bus will route a sent message to all PushEndpoint which are registered against that path.
...
public interface EventBus {
    ...
    public static interface Reply {
        ...
        /**
         * Invoked when the {@link org.primefaces.push.EventBus} delivered the message to all
         * {@link org.primefaces.push.annotation.PushEndpoint} that matches the path used to initiate the publish operation.
         */
