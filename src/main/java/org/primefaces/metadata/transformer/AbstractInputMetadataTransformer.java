...
public abstract class AbstractInputMetadataTransformer implements MetadataTransformer {
    ...
    @Override
    public void transform(FacesContext context, ApplicationContext applicationContext, UIComponent component) throws IOException {
    ...
    protected abstract void transformInput(FacesContext context, ApplicationContext applicationContext, UIInput component) throws IOException;
