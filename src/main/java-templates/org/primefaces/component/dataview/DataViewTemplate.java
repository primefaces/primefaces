...
import org.primefaces.PrimeFaces;
    ...
    public static final String HEADER_CLASS = "ui-dataview-header ui-widget-header ui-corner-top";
    public static final String FOOTER_CLASS = "ui-dataview-footer ui-widget-header ui-corner-bottom";
    public static final String TABLE_CONTENT_CLASS = "ui-dataview-content ui-widget-content ui-g-12";
    public static final String EMPTY_CONTENT_CLASS = "ui-dataview-content ui-datagrid-content-empty ui-widget-content";
	public static final String TABLE_CLASS = "ui-dataview-data ui-g-12";
	public static final String TABLE_ROW_CLASS = "ui-dataview-row";
    public static final String GRID_CONTENT_CLASS = "ui-dataview-content ui-widget-content ui-grid ui-grid-responsive";
    public static final String GRID_ROW_CLASS = "ui-g";
    public static final String COLUMN_CLASS = "ui-dataview-column";
