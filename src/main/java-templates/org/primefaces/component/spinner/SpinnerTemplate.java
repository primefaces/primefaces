    ...
    //public final static String INPUT_CLASS = "ui-inputfield ui-widget ui-state-default ui-corner-bl ui-corner-tl";
    public final static String INPUT_CLASS = "ui-spinner-input";
    public final static String UP_BUTTON_CLASS = "ui-spinner-button ui-spinner-up ui-corner-br ui-button ui-widget ui-state-default ui-button-text-only";
