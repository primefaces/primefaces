...
------------ | -------------  | ------------- | ------------- | ------------- | ------------- |
12.0.0-RC1| [primefaces-12.0.0-RC1.jar](https://search.maven.org/remotecontent?filepath=org/primefaces/primefaces/12.0.0-RC1/primefaces-12.0.0-RC1.jar)  | [primefaces-12.0.0-RC1-sources.jar](https://search.maven.org/remotecontent?filepath=org/primefaces/primefaces/12.0.0-RC1/primefaces-12.0.0-RC1-sources.jar) | 2.0 - 4.0 | 1.8 - ? | [12.0.0 Documentation](https://primefaces.github.io/primefaces/12_0_0/#/)
