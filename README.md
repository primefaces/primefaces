...
------------ | -------------  | ------------- | ------------- | ------------- | ------------- |
![14.0.x](https://img.shields.io/maven-central/v/org.primefaces/primefaces.svg?versionPrefix=14&color=cyan)| [JAR](https://search.maven.org/remotecontent?filepath=org/primefaces/primefaces/14.0.2/primefaces-14.0.2.jar)  | [Sources](https://search.maven.org/remotecontent?filepath=org/primefaces/primefaces/14.0.2/primefaces-14.0.2-sources.jar)| 2.3 - 4.0 | ![Java](https://img.shields.io/badge/Java%2011+-blue.svg)  | [14.0.2 Documentation](https://primefaces.github.io/primefaces/14_0_0/#/)
![13.0.x](https://img.shields.io/maven-central/v/org.primefaces/primefaces.svg?versionPrefix=13&color=cyan)| [JAR](https://search.maven.org/remotecontent?filepath=org/primefaces/primefaces/13.0.10/primefaces-13.0.10.jar)  | [Sources](https://search.maven.org/remotecontent?filepath=org/primefaces/primefaces/13.0.10/primefaces-13.0.10-sources.jar) | 2.0 - 4.0 |  ![Java](https://img.shields.io/badge/Java%208+-blue.svg) | [13.0.10 Documentation](https://primefaces.github.io/primefaces/13_0_0/#/)
![12.0.x](https://img.shields.io/maven-central/v/org.primefaces/primefaces.svg?versionPrefix=12&color=cyan)| [JAR](https://search.maven.org/remotecontent?filepath=org/primefaces/primefaces/12.0.0/primefaces-12.0.0.jar)  | [Sources](https://search.maven.org/remotecontent?filepath=org/primefaces/primefaces/12.0.0/primefaces-12.0.0-sources.jar) | 2.0 - 4.0 | ![Java](https://img.shields.io/badge/Java%208+-blue.svg) | [12.0.0 Documentation](https://primefaces.github.io/primefaces/12_0_0/#/)
...
***
- Run `mvn versions:set -DgenerateBackupPoms=false -DnewVersion=14.0.2` to update all modules versions
- Commit and push the changes to GitHub
- In GitHub create a new Release titled `14.0.2` to tag this release
