...
public class Watermark extends UIComponentBase implements org.primefaces.component.api.Widget {
	...
	public void setForElement(java.lang.String _forElement) {
		getStateHelper().put(PropertyKeys.forElement, _forElement);
		handleAttribute("forElement", _forElement);
	}
