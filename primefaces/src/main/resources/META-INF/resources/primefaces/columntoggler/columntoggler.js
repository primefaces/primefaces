...
PrimeFaces.widget.ColumnToggler = PrimeFaces.widget.DeferredWidget.extend({
    ...
    render: function() {
        ...
        this.panel = $(PrimeFaces.escapeClientId(this.cfg.id)).attr('role', 'dialog').addClass('ui-columntoggler ui-widget ui-widget-content')
     ...
     */
    toggleAll: function() {
        if (this.selectAllCheckbox.find('> .ui-chkbox > .ui-chkbox-box').hasClass('ui-state-active')) {
            this.uncheckAll();
        }
        else {
            this.checkAll();
