if (!PrimeFaces.dialog) {
    ...
    PrimeFaces.dialog.DialogHandler = {
        ...
        openDialog: function(cfg) {
            ...
            dialogDOM = $('<div id="' + dialogId + '" class="ui-dialog ui-widget ui-widget-content ui-hidden-container ui-overlay-hidden ' + styleClass + '"' +
        ...
        showMessageInDialog: function(msg) {
            if(!this.messageDialog) {
                $('<div id="primefacesmessagedlg" class="ui-message-dialog ui-dialog ui-widget ui-widget-content ui-hidden-container"></div>')
