(function(window) {
    ...
    var PrimeFaces = {
         ...
         * @param {(PrimeFaces.widget.BaseWidget, JQuery.AjaxSettings) => boolean} [isXhrSource] Callback that checks if the widget is the source of the current AJAX request.
         */
