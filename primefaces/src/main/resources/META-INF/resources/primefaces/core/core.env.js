if (!PrimeFaces.env) {
    ...
    PrimeFaces.env = {
        ...
        ios: false,
        /**
         * `true` if the current enviroment is Microsoft Windows, `false` otherwise.
         * @type {boolean}
         */
        mswindows: false,
        /**
        ...
        init: function () {
            ...
            this.ios = /iPhone|iPad|iPod/i.test(agent) || (/mac/i.test(agent) && PrimeFaces.env.touch);
            this.android = /(android)/i.test(agent);
            ...
            this.mswindows = agent.indexOf('Windows') > -1;
        },
