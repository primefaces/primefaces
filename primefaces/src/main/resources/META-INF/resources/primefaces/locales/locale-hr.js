if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["hr"] = {
    ...
    aria: {
      ...
      star: "1 zvjezdica",
      stars: "Zvjezdica {star}",
      trueLabel: "Da",
      unselectAll: "Poništi odabir svih stavki",
      unselectLabel: "Poništi odabir",
      unselectRow: "Poništi odabir retka",
  ...
  PrimeFaces.locales["hr"] = $.extend(true, {}, PrimeFaces.locales["hr"], {
    ...
    messages: {
      ...
      "javax.validation.constraints.AssertFalse.message": "mora biti neistinito",
      "javax.validation.constraints.AssertTrue.message": "mora biti istinito",
      ...
      "javax.validation.constraints.Digits.message": "numerička vrijednost je izvan granica (očekuje se &lt;{0} znamenki&gt;.&lt;{1} znamenki&gt;)",
      "javax.validation.constraints.Email.message": "mora biti ispravno oblikovana adresa e-pošte",
      "javax.validation.constraints.Future.message": "mora biti budući datum",
      "javax.validation.constraints.FutureOrPresent.message": "mora biti današnji ili budući datum",
      ...
      "javax.validation.constraints.NotBlank.message": "ne smije biti prazno ili sadržavati samo razmake",
      ...
      "javax.validation.constraints.PastOrPresent.message": "mora biti prošli ili današnji datum",
      "javax.validation.constraints.Pattern.message": "mora odgovarati uzorku '{0}'",
