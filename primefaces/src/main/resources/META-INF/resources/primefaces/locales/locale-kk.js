if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["kk"] = $.extend(true, {}, PrimeFaces.locales["kk"], {
    ...
    messages: {
      ...
      "javax.validation.constraints.DecimalMax.message": "{0} аспауы керек.",
      "javax.validation.constraints.DecimalMin.message": "{0} кем болмауы керек.",
      "javax.validation.constraints.Digits.message": "сандық мән шегінен тыс (&lt;{0} сан&gt;.&lt;{1} сан&gt; күтілуде).",
      "javax.validation.constraints.Future.message": "болашақта болуы керек.",
      "javax.validation.constraints.Max.message": "{0} аспауы керек.",
      "javax.validation.constraints.Min.message": "{0} кем болмауы керек.",
      ...
      "javax.validation.constraints.Past.message": "өткен уақытта болуы керек.",
      "javax.validation.constraints.Pattern.message": "'{0}' сәйкес болуы керек.",
      "javax.validation.constraints.Size.message": "өлшемі {0} мен {1} аралығында болуы керек.",
    },
  });
}
