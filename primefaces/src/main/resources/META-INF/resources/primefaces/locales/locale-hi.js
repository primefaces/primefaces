if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["hi"] = $.extend(true, {}, PrimeFaces.locales["hi"], {
    ...
    messages: {
      ...
      "javax.validation.constraints.AssertFalse.message": "गलत होना चाहिए।",
      "javax.validation.constraints.AssertTrue.message": "सत्य होना चाहिए।",
      "javax.validation.constraints.DecimalMax.message": "{0} से कम या उसके बराबर होना चाहिए।",
      "javax.validation.constraints.DecimalMin.message": "{0} से बड़ा या उसके बराबर होना चाहिए।",
      "javax.validation.constraints.Digits.message": "संख्यात्मक मान सीमा से बाहर है (&lt;{0} अंक&gt;.&lt;{1} अंक&gt; अपेक्षित)।",
