 ...
 PrimeFaces.locales['hi'] = $.extend(true, {}, PrimeFaces.locales['hi'], {
     weekNumberTitle: 'W',
     isRTL: false,
     yearSuffix: 'वर्षप्रत्यय',
     timeOnlyTitle: 'केवल समयशीर्षक',
     timeText: 'समयपाठ',
     hourText: 'घंटापाठ',
     minuteText: 'मिनटपाठ',
     secondText: 'सेकंड पाठ',
     ...
     day: 'दिन',
     list: 'सूची',
     allDayText: 'पूरे दिन का पाठ',
     moreLinkText: 'अधिक लिंक पाठ',
     noEventsText: 'कोई घटना पाठ नहीं',
     aria: {
         'datatable.sort.ASC': 'कॉलम को आरोही क्रम में क्रमबद्ध करने के लिए सक्रिय करें',
         'datatable.sort.DESC': 'कॉलम को अवरोही क्रम में क्रमबद्ध करने के लिए सक्रिय करें',
         'datatable.sort.NONE': 'कॉलम पर सॉर्टिंग हटाने के लिए सक्रिय करें',
         'colorpicker.OPEN': 'रंग चयनकर्ता खोलें',
         'colorpicker.CLOSE': 'रंग चयनकर्ता बंद करें',
         'colorpicker.CLEAR': 'चयनित रंग साफ़ करें',
         'colorpicker.MARKER': 'परिपूर्णता: {s}. चमक: {v}.',
         'colorpicker.HUESLIDER': 'रंग स्लाइडर',
         'colorpicker.ALPHASLIDER': 'अपारदर्शिता स्लाइडर',
         'colorpicker.INPUT': 'रंग मान फ़ील्ड',
         'colorpicker.FORMAT': 'रंग प्रारूप',
         'colorpicker.SWATCH': 'रंग नमूना',
         'colorpicker.INSTRUCTION': 'संतृप्ति और चमक चयनकर्ता. चयन करने के लिए ऊपर, नीचे, बाएँ और दाएँ तीर कुंजियों का उपयोग करें.',
         'spinner.INCREASE': 'मूल्य बढ़ाएँ',
         'spinner.DECREASE': 'मूल्य बढ़ाएँ',
         'switch.ON': 'चालू',
         'switch.OFF': 'बंद',
