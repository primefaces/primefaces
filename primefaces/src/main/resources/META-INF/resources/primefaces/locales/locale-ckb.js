if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["ckb"] = $.extend(true, {}, PrimeFaces.locales["ckb"], {
    ...
    messages: {
      ...
      "javax.validation.constraints.DecimalMin.message": "دەبێت گەورەتر بێت یان یەکسان بێت بە {0}.",
      "javax.validation.constraints.Digits.message": "بەهای ژمارەیی لە دەرەوەی سنوورەکان (&lt;{0} ژمارە&gt;.&lt;{1} ژمارە&gt; چاوەڕوان دەکرێت).",
