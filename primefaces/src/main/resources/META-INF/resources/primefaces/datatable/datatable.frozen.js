...
PrimeFaces.widget.FrozenDataTable = PrimeFaces.widget.DataTable.extend({
    ...
    setupScrolling: function() {
        ...
        const alignFrozenColumnsRight = this.jq.find('> table > tbody > tr > td').first().hasClass('ui-datatable-frozenlayout-right')
        this.scrollThead = this.thead.eq(alignFrozenColumnsRight ? 0 : 1);
        this.scrollTbody = this.tbody.eq(alignFrozenColumnsRight ? 0 : 1);
        this.scrollTfoot = this.tfoot.eq(alignFrozenColumnsRight ? 0 : 1);
        ...
        this.frozenThead = this.thead.eq(alignFrozenColumnsRight ? 1 : 0);
        this.frozenTbody = this.tbody.eq(alignFrozenColumnsRight ? 1 : 0);
        this.frozenTfoot = this.tfoot.eq(alignFrozenColumnsRight ? 1 : 0);
