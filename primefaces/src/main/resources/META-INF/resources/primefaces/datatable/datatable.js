...
PrimeFaces.widget.DataTable = PrimeFaces.widget.DeferredWidget.extend({
    ...
    _render: function() {
        ...
        // cell navigation is enabled by default, but it is disabled when editing or row selection is enabled (unless explicitly specified by the user).
        if (this.cfg.cellNavigation === undefined) {
            this.cfg.cellNavigation = !(this.cfg.editMode || this.cfg.selectionRowMode !== 'none');
        }
