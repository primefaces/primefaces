if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["ro"] = $.extend(true, {}, PrimeFaces.locales["ro"], {
    ...
    messages: {
      ...
      "jakarta.validatio.constraints.AssertFalse.message": "trebuie să fie fals",
      "jakarta.validatio.constraints.AssertTrue.message": "trebuie să fie adevărat",
      "jakarta.validatio.constraints.DecimalMax.message": "trebuie să fie mai mic sau egal cu {0}",
      "jakarta.validatio.constraints.DecimalMin.message": "trebuie să fie mai mare sau egal cu {0}",
      "jakarta.validatio.constraints.Digits.message": "valoare numerică în afara limitelor (&lt;{0} cifre&gt;.&lt;{1} cifre&gt; așteptate)",
      "jakarta.validatio.constraints.Email.message": "trebuie să fie o adresă de e-mail bine formată",
      "jakarta.validatio.constraints.Future.message": "trebuie să fie o dată viitoare",
      "jakarta.validatio.constraints.FutureOrPresent.message": "trebuie să fie o dată în prezent sau în viitor",
      "jakarta.validatio.constraints.Max.message": "trebuie să fie mai mic sau egal cu {0}",
      "jakarta.validatio.constraints.Min.message": "trebuie să fie mai mare sau egal cu {0}",
      "jakarta.validatio.constraints.Negative.message": "trebuie să fie mai mică de 0",
      "jakarta.validatio.constraints.NegativeOrZero.message": "trebuie să fie mai mică sau egală cu 0",
      "jakarta.validatio.constraints.NotBlank.message": "nu trebuie să fie goală",
      "jakarta.validatio.constraints.NotEmpty.message": "nu trebuie să fie goale",
      "jakarta.validatio.constraints.NotNull.message": "nu trebuie să fie nulă",
      "jakarta.validatio.constraints.Null.message": "trebuie să fie nulă",
      "jakarta.validatio.constraints.Past.message": "trebuie să fie o întâlnire trecută",
      "jakarta.validatio.constraints.PastOrPresent.message": "trebuie să fie o dată în trecut sau în prezent",
      "jakarta.validatio.constraints.Pattern.message": "trebuie să se potrivească cu „{0}”",
      "jakarta.validatio.constraints.Positive.message": "trebuie să fie mai mare decât 0",
      "jakarta.validatio.constraints.PositiveOrZero.message": "trebuie să fie mai mare sau egal cu 0",
      "jakarta.validatio.constraints.Size.message": "dimensiunea trebuie să fie între {0} și {1}",
    },
  });
}
