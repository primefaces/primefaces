if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["sv"] = $.extend(true, {}, PrimeFaces.locales["sv"], {
    ...
    messages: {
      ...
      "jakarta.validatio.constraints.AssertFalse.message": "måste vara falskt",
      "jakarta.validatio.constraints.AssertTrue.message": "måste vara sant",
      "jakarta.validatio.constraints.DecimalMax.message": "måste vara mindre än eller lika med {0}",
      "jakarta.validatio.constraints.DecimalMin.message": "måste vara större än eller lika med {0}",
      "jakarta.validatio.constraints.Digits.message": "numeriskt värde utanför gränserna (&lt;{0} siffror&gt;.&lt;{1} siffror&gt; förväntat)",
      "jakarta.validatio.constraints.Email.message": "måste vara en väl utformad e-postadress",
      "jakarta.validatio.constraints.Future.message": "måste vara ett framtida datum",
      "jakarta.validatio.constraints.FutureOrPresent.message": "måste vara ett datum i nuet eller i framtiden",
      "jakarta.validatio.constraints.Max.message": "måste vara mindre än eller lika med {0}",
      "jakarta.validatio.constraints.Min.message": "måste vara större än eller lika med {0}",
      "jakarta.validatio.constraints.Negative.message": "måste vara mindre än 0",
      "jakarta.validatio.constraints.NegativeOrZero.message": "måste vara mindre än eller lika med 0",
      "jakarta.validatio.constraints.NotBlank.message": "får inte vara tom",
      "jakarta.validatio.constraints.NotEmpty.message": "får inte vara tom",
      "jakarta.validatio.constraints.NotNull.message": "får inte vara null",
      "jakarta.validatio.constraints.Null.message": "måste vara null",
      "jakarta.validatio.constraints.Past.message": "måste vara ett tidigare datum",
      "jakarta.validatio.constraints.PastOrPresent.message": "måste vara ett datum i det förflutna eller i nuet",
      "jakarta.validatio.constraints.Pattern.message": "måste matcha &quot;{0}&quot;",
      "jakarta.validatio.constraints.Positive.message": "måste vara större än 0",
      "jakarta.validatio.constraints.PositiveOrZero.message": "måste vara större än eller lika med 0",
      "jakarta.validatio.constraints.Size.message": "storleken måste vara mellan {0} och {1}",
