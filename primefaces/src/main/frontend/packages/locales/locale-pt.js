if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["pt_PT"] = $.extend(true, {}, PrimeFaces.locales["pt"], {
    ...
    messages: {
      ...
      "jakarta.validatio.constraints.AssertFalse.message": "deve ser falso",
      "jakarta.validatio.constraints.AssertTrue.message": "deve ser verdadeiro",
      "jakarta.validatio.constraints.DecimalMax.message": "deve ser menor ou igual a {0}",
      "jakarta.validatio.constraints.DecimalMin.message": "deve ser maior ou igual a {0}",
      "jakarta.validatio.constraints.Digits.message": "valor numérico fora dos limites (&lt;{0} digitos&gt;.&lt;{1} digitos&gt; eesperado).",
      "jakarta.validatio.constraints.Future.message": "deve estar no futuro",
      "jakarta.validatio.constraints.Max.message": "deve ser menor ou igual a {0}",
      "jakarta.validatio.constraints.Min.message": "deve ser maior ou igual a {0}",
      "jakarta.validatio.constraints.NotBlank.message": "pode não estar nulo",
      "jakarta.validatio.constraints.NotEmpty.message": "pode não estar nulo",
      "jakarta.validatio.constraints.NotNull.message": "pode não estar nulo",
      "jakarta.validatio.constraints.Null.message": "deve estar nulo",
      "jakarta.validatio.constraints.Past.message": "deve estar no passado",
      "jakarta.validatio.constraints.Pattern.message": 'deve corresponder a "{0}"',
      "jakarta.validatio.constraints.Size.message": "o tamanho deve estar entre {0} e {1}",
    },
  });
  ...
  PrimeFaces.locales["pt_BR"] = $.extend(true, {}, PrimeFaces.locales["pt"], {
    ...
    messages: {
      ...
      "jakarta.validatio.constraints.DecimalMax.message": "deve ser menor ou igual a {0}.",
      "jakarta.validatio.constraints.DecimalMin.message": "deve ser maior ou igual a {0}.",
      "jakarta.validatio.constraints.Digits.message": "valor numérico fora dos limites (&lt;{0} digitos&gt;.&lt;{1} digitos&gt; esperado).",
      "jakarta.validatio.constraints.Email.message": "deve ser um endereço de e-mail bem formado",
      "jakarta.validatio.constraints.Future.message": "deve estar no futuro.",
      "jakarta.validatio.constraints.FutureOrPresent.message": "deve ser uma data no presente ou no futuro",
      "jakarta.validatio.constraints.Max.message": "deve ser menor ou igual a {0}",
      "jakarta.validatio.constraints.Min.message": "deve ser maior ou igual a {0}.",
      "jakarta.validatio.constraints.Negative.message": "deve ser menor que 0",
      "jakarta.validatio.constraints.NegativeOrZero.message": "deve ser menor ou igual a 0",
      "jakarta.validatio.constraints.NotBlank.message": "pode não estar nulo",
      "jakarta.validatio.constraints.NotEmpty.message": "pode não estar nulo",
      "jakarta.validatio.constraints.NotNull.message": "não pode ser nulo.",
      "jakarta.validatio.constraints.Null.message": "deve ser nulo.",
      "jakarta.validatio.constraints.Past.message": "deve estar no passado.",
      "jakarta.validatio.constraints.PastOrPresent.message": "deve ser uma data no passado ou no presente",
      "jakarta.validatio.constraints.Pattern.message": 'deve corresponder "{0}".',
      "jakarta.validatio.constraints.Positive.message": "deve ser maior que 0",
      "jakarta.validatio.constraints.PositiveOrZero.message": "deve ser maior ou igual a 0",
      "jakarta.validatio.constraints.Size.message": "o tamanho deve estar entre {0} e {1}.",
    },
  });
}
