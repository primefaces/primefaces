if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["en"] = $.extend(true, {}, PrimeFaces.locales["en"], {
    ...
    messages: {
      ...
      "jakarta.validatio.constraints.AssertFalse.message": "must be false.",
      "jakarta.validatio.constraints.AssertTrue.message": "must be true.",
      "jakarta.validatio.constraints.DecimalMax.message": "must be less than or equal to {0}.",
      "jakarta.validatio.constraints.DecimalMin.message": "must be greater than or equal to {0}.",
      "jakarta.validatio.constraints.Digits.message": "numeric value out of bounds (&lt;{0} digits&gt;.&lt;{1} digits&gt; expected).",
      "jakarta.validatio.constraints.Email.message": "must be a well-formed email address.",
      "jakarta.validatio.constraints.Future.message": "must be a future date.",
      "jakarta.validatio.constraints.FutureOrPresent.message": "must be a date in the present or in the future.",
      "jakarta.validatio.constraints.Max.message": "must be less than or equal to {0}.",
      "jakarta.validatio.constraints.Min.message": "must be greater than or equal to {0}.",
      "jakarta.validatio.constraints.Negative.message": "must be less than 0.",
      "jakarta.validatio.constraints.NegativeOrZero.message": "must be less than or equal to 0.",
      "jakarta.validatio.constraints.NotBlank.message": "must not be blank.",
      "jakarta.validatio.constraints.NotEmpty.message": "must not be empty.",
      "jakarta.validatio.constraints.NotNull.message": "must not be null.",
      "jakarta.validatio.constraints.Null.message": "must be null.",
      "jakarta.validatio.constraints.Past.message": "must be a past date.",
      "jakarta.validatio.constraints.PastOrPresent.message": "must be a date in the past or in the present.",
      "jakarta.validatio.constraints.Pattern.message": "must match '{0}'.",
      "jakarta.validatio.constraints.Positive.message": "must be greater than 0.",
      "jakarta.validatio.constraints.PositiveOrZero.message": "must be greater than or equal to 0.",
      "jakarta.validatio.constraints.Size.message": "size must be between {0} and {1}.",
    },
  });
  // United States
