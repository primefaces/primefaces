if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["kk"] = $.extend(true, {}, PrimeFaces.locales["kk"], {
    ...
    messages: {
      ...
      "jakarta.validation.constraints.AssertFalse.message": "жалған болуы керек",
      "jakarta.validation.constraints.AssertTrue.message": "шын болуы керек",
      "jakarta.validation.constraints.DecimalMax.message": "{0} мәнінен кем немесе оған тең болуы керек",
      "jakarta.validation.constraints.DecimalMin.message": "{0} мәнінен үлкен немесе оған тең болуы керек",
      "jakarta.validation.constraints.Digits.message": "сандық мән шектен тыс (&lt;{0} цифр&gt;.&lt;{1} цифр&gt; күтілетін)",
      "jakarta.validation.constraints.Email.message": "жақсы қалыптасқан электрондық пошта мекенжайы болуы керек",
      "jakarta.validation.constraints.Future.message": "болашақ күн болуы керек",
      "jakarta.validation.constraints.FutureOrPresent.message": "қазіргі немесе болашақтағы күн болуы керек",
      "jakarta.validation.constraints.Max.message": "{0} мәнінен кем немесе оған тең болуы керек",
      "jakarta.validation.constraints.Min.message": "{0} мәнінен үлкен немесе оған тең болуы керек",
      "jakarta.validation.constraints.Negative.message": "0-ден аз болуы керек",
      "jakarta.validation.constraints.NegativeOrZero.message": "0-ден кем немесе оған тең болуы керек",
      "jakarta.validation.constraints.NotBlank.message": "бос болмауы керек",
      "jakarta.validation.constraints.NotEmpty.message": "бос болмауы керек",
      "jakarta.validation.constraints.NotNull.message": "нөл болмауы керек",
      "jakarta.validation.constraints.Null.message": "нөл болуы керек",
      "jakarta.validation.constraints.Past.message": "өткен күн болуы керек",
      "jakarta.validation.constraints.PastOrPresent.message": "өткен немесе қазіргі күн болуы керек",
      "jakarta.validation.constraints.Pattern.message": "&quot;{0}&quot; сәйкес келуі керек",
      "jakarta.validation.constraints.Positive.message": "0-ден үлкен болуы керек",
      "jakarta.validation.constraints.PositiveOrZero.message": "0-ден үлкен немесе оған тең болуы керек",
      "jakarta.validation.constraints.Size.message": "өлшем {0} және {1} арасында болуы керек",
    },
  });
}
