if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["it"] = $.extend(true, {}, PrimeFaces.locales["it"], {
    ...
    messages: {
      ...
      "jakarta.validatio.constraints.AssertFalse.message": "dev'essere falso.",
      "jakarta.validatio.constraints.AssertTrue.message": "dev'essere vero.",
      "jakarta.validatio.constraints.DecimalMax.message": "dev'essere minore o uguale a {0}.",
      "jakarta.validatio.constraints.DecimalMin.message": "dev'essere maggiore o uguale a {0}.",
      "jakarta.validatio.constraints.Digits.message": "valore numerico fuori intervallo (numero di cifre previste compreso tra {0} e {1}).",
      "jakarta.validatio.constraints.Email.message": "deve essere un indirizzo email ben formato",
      "jakarta.validatio.constraints.Future.message": "dev'essere nel futuro.",
      "jakarta.validatio.constraints.FutureOrPresent.message": "deve essere una data nel presente o nel futuro",
      "jakarta.validatio.constraints.Max.message": "dev'essere minore o uguale a {0}.",
      "jakarta.validatio.constraints.Min.message": "dev'essere maggiore o uguale a {0}.",
      "jakarta.validatio.constraints.Negative.message": "deve essere inferiore a 0",
      "jakarta.validatio.constraints.NegativeOrZero.message": "deve essere minore o uguale a 0",
      "jakarta.validatio.constraints.NotBlank.message": "non può essere nullo.",
      "jakarta.validatio.constraints.NotEmpty.message": "non può essere nullo.",
      "jakarta.validatio.constraints.NotNull.message": "non può essere nullo.",
      "jakarta.validatio.constraints.Null.message": "dev'essere nullo.",
      "jakarta.validatio.constraints.Past.message": "dev'essere nel passato.",
      "jakarta.validatio.constraints.PastOrPresent.message": "deve essere una data nel passato o nel presente",
      "jakarta.validatio.constraints.Pattern.message": 'deve soddisfare l\'espressione "{0}".',
      "jakarta.validatio.constraints.Positive.message": "deve essere maggiore di 0",
      "jakarta.validatio.constraints.PositiveOrZero.message": "deve essere maggiore o uguale a 0",
      "jakarta.validatio.constraints.Size.message": "la dimensione dev'essere compresa tra {0} e {1}.",
    },
  });
}
