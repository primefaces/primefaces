if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["pl"] = $.extend(true, {}, PrimeFaces.locales["pl"], {
    ...
    messages: {
      ...
      "jakarta.validatio.constraints.AssertFalse.message": "musi być fałszywe",
      "jakarta.validatio.constraints.AssertTrue.message": "musi być prawdą",
      "jakarta.validatio.constraints.DecimalMax.message": "musi być mniejszy lub równy {0}",
      "jakarta.validatio.constraints.DecimalMin.message": "musi być większy lub równy {0}",
      "jakarta.validatio.constraints.Digits.message": "wartość liczbowa poza zakresem (oczekiwano &lt;{0} cyfr&gt;. &lt;{1} cyfr&gt;)",
      "jakarta.validatio.constraints.Email.message": "musi to być dobrze sformułowany adres e-mail",
      "jakarta.validatio.constraints.Future.message": "musi być datą przyszłą",
      "jakarta.validatio.constraints.FutureOrPresent.message": "musi być datą w teraźniejszości lub przyszłości",
      "jakarta.validatio.constraints.Max.message": "musi być mniejszy lub równy {0}",
      "jakarta.validatio.constraints.Min.message": "musi być większy lub równy {0}",
      "jakarta.validatio.constraints.Negative.message": "musi być mniejsza niż 0",
      "jakarta.validatio.constraints.NegativeOrZero.message": "musi być mniejsza lub równa 0",
      "jakarta.validatio.constraints.NotBlank.message": "nie może być puste",
      "jakarta.validatio.constraints.NotEmpty.message": "nie może być pusty",
      "jakarta.validatio.constraints.NotNull.message": "nie może mieć wartości null",
      "jakarta.validatio.constraints.Null.message": "musi mieć wartość zerową",
      "jakarta.validatio.constraints.Past.message": "musi to być data z przeszłości",
      "jakarta.validatio.constraints.PastOrPresent.message": "musi być datą w przeszłości lub teraźniejszości",
      "jakarta.validatio.constraints.Pattern.message": "musi pasować do „{0}”",
      "jakarta.validatio.constraints.Positive.message": "musi być większa niż 0",
      "jakarta.validatio.constraints.PositiveOrZero.message": "musi być większa lub równa 0",
      "jakarta.validatio.constraints.Size.message": "rozmiar musi mieścić się w przedziale od {0} do {1}",
