if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["es"] = $.extend(true, {}, PrimeFaces.locales["es"], {
    ...
    messages: {
      ...
      "jakarta.validatio.constraints.AssertFalse.message": "debe ser falso",
      "jakarta.validatio.constraints.AssertTrue.message": "debe ser verdadero",
      "jakarta.validatio.constraints.DecimalMax.message": "debe ser menor o igual que {0}",
      "jakarta.validatio.constraints.DecimalMin.message": "debe ser mayor o igual que {0}",
      "jakarta.validatio.constraints.Digits.message": "valor numérico fuera de los límites (se esperaba (<{0} digitos>.<{1} digitos>)",
      "jakarta.validatio.constraints.Email.message": "debe ser una dirección de correo electrónico bien formada",
      "jakarta.validatio.constraints.Future.message": "debe ser una fecha posterior",
      "jakarta.validatio.constraints.FutureOrPresent.message": "debe ser una fecha en el presente o en el futuro",
      "jakarta.validatio.constraints.Max.message": "debe ser menor o igual que {0}",
      "jakarta.validatio.constraints.Min.message": "debe ser mayor o igual que {0}",
      "jakarta.validatio.constraints.Negative.message": "debe ser menor que 0",
      "jakarta.validatio.constraints.NegativeOrZero.message": "debe ser menor o igual a 0",
      "jakarta.validatio.constraints.NotBlank.message": "no debe ser nulo",
      "jakarta.validatio.constraints.NotEmpty.message": "no debe ser nulo",
      "jakarta.validatio.constraints.NotNull.message": "no debe ser nulo",
      "jakarta.validatio.constraints.Null.message": "debe ser nulo",
      "jakarta.validatio.constraints.Past.message": "debe ser una fecha anterior",
      "jakarta.validatio.constraints.PastOrPresent.message": "debe ser una fecha en el pasado o en el presente",
      "jakarta.validatio.constraints.Pattern.message": "debe coincidir con '{0}'",
      "jakarta.validatio.constraints.Positive.message": "debe ser mayor que 0",
      "jakarta.validatio.constraints.PositiveOrZero.message": "debe ser mayor o igual a 0",
      "jakarta.validatio.constraints.Size.message": "el tamaño debe estar entre {0} y {1}",
