if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["de"] = $.extend(true, {}, PrimeFaces.locales["de"], {
    ...
    messages: {
      ...
      "jakarta.validatio.constraints.AssertFalse.message": "Muss falsch sein",
      "jakarta.validatio.constraints.AssertTrue.message": "Muss wahr sein",
      "jakarta.validatio.constraints.DecimalMax.message": "Muss kleiner oder gleich {0} sein",
      "jakarta.validatio.constraints.DecimalMin.message": "Muss größer oder gleich {0} sein",
      "jakarta.validatio.constraints.Digits.message": "Zahl außerhalb der Grenzen. (<{0} Ziffern>.<{1} Ziffern> möglich)",
      "jakarta.validatio.constraints.Email.message": "muss eine korrekte E-Mail-Adresse sein",
      "jakarta.validatio.constraints.Future.message": "Muss in der Zukunft liegen",
      "jakarta.validatio.constraints.FutureOrPresent.message": "muss ein Datum in der Gegenwart oder in der Zukunft sein",
      "jakarta.validatio.constraints.Max.message": "Muss kleiner oder gleich {0} sein",
      "jakarta.validatio.constraints.Min.message": "Muss größer oder gleich {0} sein",
      "jakarta.validatio.constraints.Negative.message": "muss kleiner als 0 sein",
      "jakarta.validatio.constraints.NegativeOrZero.message": "muss kleiner oder gleich 0 sein",
      "jakarta.validatio.constraints.NotBlank.message": "darf nicht leer sein",
      "jakarta.validatio.constraints.NotEmpty.message": "darf nicht leer sein",
      "jakarta.validatio.constraints.NotNull.message": "darf nicht Null sein",
      "jakarta.validatio.constraints.Null.message": "Muss Null sein",
      "jakarta.validatio.constraints.Past.message": "Muss in der Vergangenheit liegen",
      "jakarta.validatio.constraints.PastOrPresent.message": "muss ein Datum in der Vergangenheit oder in der Gegenwart sein",
      "jakarta.validatio.constraints.Pattern.message": 'Muss gleich "{0}" sein',
      "jakarta.validatio.constraints.Positive.message": "muss größer als 0 sein",
      "jakarta.validatio.constraints.PositiveOrZero.message": "muss größer oder gleich 0 sein",
      "jakarta.validatio.constraints.Size.message": "Größe muss zwischen {0} und {1} liegen",
    },
  });
