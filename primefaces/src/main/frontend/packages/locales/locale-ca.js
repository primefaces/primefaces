if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["ca"] = $.extend(true, {}, PrimeFaces.locales["ca"], {
    ...
    messages: {
      ...
      "jakarta.validatio.constraints.DecimalMax.message": "debe ser menor que o igual a {0}",
      "jakarta.validatio.constraints.DecimalMin.message": "debe ser mayor que o igual a {0}",
      "jakarta.validatio.constraints.Digits.message": "valor numérico fuera de los límites (se esperaba (<{0} digitos>.<{1} digitos>)",
      "jakarta.validatio.constraints.Future.message": "debe ser una fecha futura",
      "jakarta.validatio.constraints.Max.message": "debe ser menor que o igual a {0}",
      "jakarta.validatio.constraints.Min.message": "debe ser mayor que o igual a {0}",
      ...
      "jakarta.validatio.constraints.Past.message": "debe ser una fecha pasada",
