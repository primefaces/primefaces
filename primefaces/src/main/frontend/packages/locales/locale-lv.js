if (window.PrimeFaces) {
  ...
  PrimeFaces.locales["lv"] = $.extend(true, {}, PrimeFaces.locales["lv"], {
    ...
    messages: {
      ...
      "jakarta.validatio.constraints.AssertFalse.message": "jābūt false.",
      "jakarta.validatio.constraints.AssertTrue.message": "jābūt true.",
      "jakarta.validatio.constraints.DecimalMax.message": "jābūt mazākam vai vienādam ar {0}.",
      "jakarta.validatio.constraints.DecimalMin.message": "jābūt lielākam vai vienādam ar {0}.",
      "jakarta.validatio.constraints.Digits.message": "skaitliskā vērtība ārpus robežām (paredzēts &lt;{0} cipari&gt;.&lt;{1} cipari&gt;).",
      "jakarta.validatio.constraints.Email.message": "jābūt pareizi izveidotai e-pasta adresei",
      "jakarta.validatio.constraints.Future.message": "jābūt nākotnē.",
      "jakarta.validatio.constraints.FutureOrPresent.message": "jābūt datumam tagadnē vai nākotnē",
      "jakarta.validatio.constraints.Max.message": "jābūt mazākam vai vienādam ar {0}.",
      "jakarta.validatio.constraints.Min.message": "jābūt lielākam vai vienādam ar {0}.",
      "jakarta.validatio.constraints.Negative.message": "jābūt mazākam par 0",
      "jakarta.validatio.constraints.NegativeOrZero.message": "jābūt mazākam vai vienādam ar 0",
      "jakarta.validatio.constraints.NotBlank.message": "nedrīkst būt Null.",
      "jakarta.validatio.constraints.NotEmpty.message": "nedrīkst būt Null.",
      "jakarta.validatio.constraints.NotNull.message": "nedrīkst būt Null.",
      "jakarta.validatio.constraints.Null.message": "jābūt Null.",
      "jakarta.validatio.constraints.Past.message": "jābūt pagātnē.",
      "jakarta.validatio.constraints.PastOrPresent.message": "datumam ir jābūt pagātnē vai tagadnē",
      "jakarta.validatio.constraints.Pattern.message": 'jāatbilst "{0}".',
      "jakarta.validatio.constraints.Positive.message": "jābūt lielākam par 0",
      "jakarta.validatio.constraints.PositiveOrZero.message": "jābūt lielākam vai vienādam ar 0",
      "jakarta.validatio.constraints.Size.message": "lielumam jābūt starp {0} un {1}.",
    },
  });
}
