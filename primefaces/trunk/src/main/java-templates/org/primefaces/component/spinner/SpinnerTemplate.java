    ...
    public final static String PLAIN_INPUT_CLASS = "ui-spinner-input";
    public final static String THEME_INPUT_CLASS = "ui-spinner-input ui-inputfield ui-state-default ui-corner-all";
