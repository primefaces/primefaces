    ...
    YAHOO.extend(Layout, YAHOO.util.Element, {
        ...
        */
        addUnit: function(cfg) {
            ...
            Dom.addClass(element, 'ui-layout-wrap');
        ...
        resize: function(set, info) {
            ...
            */
            ...
            if (set) {
                ...
                if (this.browser.ie) {
                    if (this._isBody) {
                        Dom.removeClass(document.documentElement, 'ui-layout');
                        Dom.addClass(document.documentElement, 'ui-layout');
                    } else {
                        this.removeClass('ui-layout');
        ...
        */
        _setupBodyElements: function() {
            ...
            Dom.addClass(this._doc, 'ui-layout-doc');
        },
        /**
        * @private
        ...
        */
        _setupElements: function() {
            this._doc = this.getElementsByClassName('ui-layout-doc')[0];
            if (!this._doc) {
                this._doc = document.createElement('div');
        ...
        */        
        render: function() {
            ...
            if (el && el.tagName && (el.tagName.toLowerCase() == 'body')) {
                this._isBody = true;
                Dom.addClass(document.body, 'ui-layout ui-widget ui-widget-content');
                ...
                this._isBody = false;
                this.addClass('ui-layout ui-widget ui-widget-content');
                this._setupElements();
            }
            this.resize();
            this._rendered = true;
    ...
    YAHOO.extend(LayoutUnit, YAHOO.util.Element, {
        ...
        */
        _createClip: function() {
            if (!this._clip) {
	            ...
	            direction = "";
	            if(position == 'top') direction = 's';
                else if(position == 'bottom') direction = 't';
                else if(position == 'left') direction = 'e';
                else if(position == 'right') direction = 'w';
	            
                this._clip = document.createElement('div');
                this._clip.className = 'ui-layout-clip ui-layout-clip-' + position + ' ui-state-hover';
                this._clip.innerHTML = '<div class="collapse ui-icon ui-icon-circle-triangle-' + direction + '"></div>';
        ...
        */
        init: function(p_oElement, p_oAttributes) {
            ...
            this.addClass('ui-layout-unit');
            this.addClass('ui-layout-unit-' + this.get('position'));


            var header = this.getElementsByClassName('ui-layout-hd', 'div')[0];
            if (header) {
                this.header = header;
            }
            var body = this.getElementsByClassName('ui-layout-bd', 'div')[0];
            if (body) {
                this.body = body;
            }
            var footer = this.getElementsByClassName('ui-layout-ft', 'div')[0];
            if (footer) {
                this.footer = footer;
            }
            ...
            this.setAttributeConfig('header', {
                ...
                method: function(txt) {
                    if (txt === false) {
                        //Remove the footer
                        if (this.header) {
                            Dom.addClass(this.body, 'ui-layout-bd-nohd');
                ...
                method: function(content) {
                    if (!this.body) {
                        ...
                        if (body) {
                            ...
                            body.className = 'ui-layout-bd ui-widget-content';
                            this.body = body;
                    ...
                    Dom.addClass(this.body, 'ui-layout-bd-noft');
            ...
            this.setAttributeConfig('footer', {
                ...
                method: function(content) {
                    if (content === false) {
                        ...
                        if (!this.footer) {
                            var ft = this.getElementsByClassName('ui-layout-ft', 'div')[0];
                            if (!ft) {
                                ft = document.createElement('div');
                                ft.className = 'ui-layout-ft';
                                this.footer = ft;
                ...
                method: function(close) {
                    ...
                    if (close) {
                        ...
                        if (!c) {
                            ...
                            c.className = 'close ui-icon ui-icon-circle-close';
            ...
            */
            this.setAttributeConfig('collapse', {
                ...
                method: function(collapse) {
                    ...
                    if (collapse) {
	                    var direction = "";
	                    if(position == 'top') direction = 'n';
	                    else if(position == 'bottom') direction = 's';
	                    else if(position == 'left') direction = 'w';
	                    else if(position == 'right') direction = 'e';
                        ...
                        c.className = 'collapse' + ((this.get('close')) ? ' collapse-close' : '') + ' ui-icon ui-icon-circle-triangle-' + direction;
                    } else if (c && c.parentNode) {
                        Event.purgeElement(c);
                        c.parentNode.removeChild(c);
                    }
            ...
            */
            ...
            this.setAttributeConfig('scroll', {
                ...
                method: function(scroll) {
                    ...
                    if (scroll === true) {
                        this.addClass('ui-layout-scroll');
                        this.removeClass('ui-layout-noscroll');
                        if (this._lastScrollTop > 0) {
                            if (this.body) {
                                this.body.scrollTop = this._lastScrollTop;
                            }
                        ...
                        this.removeClass('ui-layout-scroll');
                        this.addClass('ui-layout-noscroll');
                    } else if (scroll === null) {
                        this.removeClass('ui-layout-scroll');
                        this.removeClass('ui-layout-noscroll');
                    }
                ...
                method: function(resize) {
                    if (resize && !this._resize) {
                        ...
                        if (handle) {
                            ...
                            this._resize._handles[handle].innerHTML = '<div class="ui-layout-resize-knob"></div>';

                            if (this.get('proxy')) {
                                var proxy = this._resize.getProxyEl();
                                proxy.innerHTML = '<div class="ui-layout-handle-' + handle + '"></div>';
                            }
        ...
        */
        _createHeader: function() {
            ...
            header.className = 'ui-layout-hd ui-widget-header';
