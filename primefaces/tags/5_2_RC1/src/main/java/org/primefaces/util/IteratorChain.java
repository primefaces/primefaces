...
/**
 * Copied from commons-collections and replaced:
 * EmptyIterator.INSTANCE -> Collections.emptyIterator()
 * UnmodifiableList.decorate(iteratorChain) -> Collections.unmodifiableList(iteratorChain)
 */
