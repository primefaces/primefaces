...
| CSP_REPORT_ONLY | false | Enable reporting for Content Security Policy violations only |
| CSP_REPORT_ENDPOINT | null | Content Security Policy endpoint to report violations to |
