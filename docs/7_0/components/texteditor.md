...
TextEditor requires the **owasp-java-html-sanitizer** dependency added to your pom.xml to prevent XSS. Rich Text entered using the Editor is passed to the server using _value_ expression.
