...
closestWidgetVar() | Returns the widgetVar of the closest parent widget of the current component EL is processed for.
closestWidgetVarFor(UIComponent) | Returns the widgetVar of the closest parent widget of the given component.
